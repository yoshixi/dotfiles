...
function! s:map_language_client_functions() abort
    if has_key(g:LanguageClient_serverCommands, &filetype)
        " nnoremap <silent> lex        :<C-u>call LanguageClient#explainErrorAtPoint()<CR>
        " nnoremap <silent> li        :<C-u>call LanguageClient#textDocument_implementation()<CR>
        " nnoremap <silent> lref       :<C-u>call LanguageClient#textDocument_references()<CR>
        ...
        nnoremap <silent> <C-]>        :<C-u>call LanguageClient#textDocument_definition()<CR>
